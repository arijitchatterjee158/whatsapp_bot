    ...
    try {
      ...
      socket.on(
        ...
        (payload: any) => {
          ...
          if (!conversationId) {
            console.warn(
              "Socket message has no conversationId"
            );
